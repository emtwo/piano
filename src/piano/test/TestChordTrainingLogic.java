...
import piano.Utils;
import piano.ui.ChordTrainingUI;

public class TestChordTrainingLogic extends ChordTrainingUI {
  ...
  public void testAlwaysCChord() {
    for (int i = 0; i < 500; i++) {
      ...
      assertTrue(firstChordVal == 48 || firstChordVal == 60 || firstChordVal == 72);
    }
  }
